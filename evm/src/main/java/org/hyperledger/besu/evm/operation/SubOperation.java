...
public class SubOperation extends AbstractFixedCostOperation {
  ...
  public static OperationResult staticOperation(final MessageFrame frame) {
    ...
    final BigInteger value0 = new BigInteger(1, frame.getStack().popUnsafe().toArrayUnsafe());
    final BigInteger value1 = new BigInteger(1, frame.getStack().popUnsafe().toArrayUnsafe());
    ...
    if (length >= 32) {
      ...
      frame.getStack().pushUnsafe(Bytes32.leftPad(Bytes.wrap(resultArray), (byte) -1));
    } else {
