...
public class SelfBalanceOperationBenchmark {
  ...
  private MessageFrame createMessageFrame(final Blockchain blockchain, final WorldUpdater worldUpdater, final ExecutionContextTestFixture executionContextTestFixture, final Address address) {
  ...
  private WorldUpdater createWorldUpdater(final Blockchain blockchain, final Address[] addresses) throws IOException {
  ...
  public void prepare() throws Exception {
    ...
    final ExecutionContextTestFixture executionContextTestFixture = ExecutionContextTestFixture.create();
    for (int i = 0; i < NUMBER_ADDRESSES; i++) {
      frames[i] = createMessageFrame(blockchain, worldUpdater, executionContextTestFixture, addresses[0]);
    }
  }
