...
public class AltBN128Benchmark extends BenchmarkExecutor {
  ...
  public void runBenchmark(final Boolean attemptNative, final String fork) {
    ...
    benchmarkAdd(gasCalculator, forkVersion);
    benchmarkMul(gasCalculator, forkVersion);
    benchmarkPairings(gasCalculator, forkVersion);
  }
  ...
  private void benchmarkAdd(
    ...
    AltBN128AddPrecompiledContract contract =
  ...
  private void benchmarkMul(
    ...
    AltBN128MulPrecompiledContract contract =
        EvmSpecVersion.ISTANBUL.compareTo(forkVersion) < 0
